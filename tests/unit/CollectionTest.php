...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @test */
    public function collection_is_instance_of_iterator_aggreagate()
    {
        $collection = new \App\Support\Collection();
    ...
    /** @test */
    public function collection_can_be_iterrated()
    {
        $collection = new \App\Support\Collection([
            'one', 'two', 'three'
        ]);
    ...
    public function collection_can_be_merged_with_another_collection()
    {
        ...
        $collectio2 = new \App\Support\Collection([
            'three', 'four', 'five'
        ]);

        $collection1->merge($collectio2);

        $this->assertInstanceOf(IteratorAggregate::class, $collection1);
